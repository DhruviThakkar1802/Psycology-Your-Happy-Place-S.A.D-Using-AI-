    ...
    <div class="container">
        <div class="login-box">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <br>
                    <h3 class="header-title">Please Select Option </h3>
                    <form class="login-form">
                        <div class="form-group">
                           
							  <div class="btn btn-primary btn-block"> <a href="load.php"> Talk With Chatbot click</a></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="btn btn-primary btn-block"><a href="index6.php">User DashBoard  Click</a></div>
                        </div>
