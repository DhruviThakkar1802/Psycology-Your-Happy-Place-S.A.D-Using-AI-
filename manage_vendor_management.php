...
if(isset($_POST['submit']))
{
	...
	$update_sql="update userinfo set FullName='$username',Password='$password',Gender='$email',MobileNo='$mobile' where UserId='$id'";
	mysqli_query($con,$update_sql);
	echo '<script type="text/javascript"> alert("User Details Updated.. Redirect to User Page") </script>';
							echo "<script type='text/javascript'> document.location = 'vendor_management.php'; </script>";
