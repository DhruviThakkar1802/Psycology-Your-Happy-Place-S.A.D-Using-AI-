...
$sql="select * from userinfo where MobileNo='{$_SESSION['MobileNo']}' ";
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span class='badge badge-edit'><a href='manage_vendor_management.php?id=".$row['UserId']."'>Edit</a></span>&nbsp;";
