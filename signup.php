    ...
    <div class="container">
        <div class="login-box">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <br>
                    <h3 class="header-title">Sign Up For Free </h3>
                    <form class="login-form">
					<div class="form-group">User ID:
                            <input name="userid" type="text" class="form-control" value=<?php $four_digit_num = mt_rand(1000, 9999);  echo $four_digit_num ?> required >
                        </div>
					 <div class="form-group">
                            <input name="username1" type="text" class="form-control" placeholder="Enter Full Name " required>
                        </div>
                        <div class="form-group">
						...
						<input name="submit_btn" type="submit" id="login_btn" value="Register Now"  class="btn btn-primary btn-block"/>

                           
                        </div>
                        <div class="form-group">
                            <div class="text-center">Register Member? <a href="Login.php">Login</a></div>
                        </div>
                    </form>
                </div>
		...
		<?php
			...
			#	$qualification = $_POST['qualification'];
				...
				if($password)
				{
					$query= "select * from userinfo WHERE MobileNo='$MobileNo'";
					$query_run = mysqli_query($con,$query);
					
					if(mysqli_num_rows($query_run)>0)
					{
						// there is already a user with the same username
						echo '<script type="text/javascript"> alert("MobileNo already exists.. try another username") </script>';
					}
					else
					{ 
				        $_SESSION["Id"]=$Id;
						$query= "insert into userinfo values('$Id','$name','$MobileNo ','$password','$Gender' ,'1')";
						$query_run = mysqli_query($con,$query);
						
						if($query_run)
						{
							echo '<script type="text/javascript"> alert("User Registered.. Redirect to User Page") </script>';
